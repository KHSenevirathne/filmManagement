...
const Shop = () => {
  ...
  const handleGenreClick = (genre) => {
    const productsByGenre = filteredProductsQuery.data?.filter(
      (product) => product.genre === genre
    );
    dispatch(setProducts(productsByGenre));
  };
  ...
  // Add "All Genres" option to uniqueGenres
  const uniqueGenres = [
    ...Array.from(
      new Set(
      ...
      <div className="container mx-auto">
        <div className="flex md:flex-row">
          <div className="bg-[#151515] p-3 mt-2 mb-2">
            <h2 className="h4 text-center py-2 bg-black rounded-full mb-2 text-white font-semibold border border-white">
            ...
            <div className="p-5">
              {uniqueGenres?.map((genre) => (
                <div key={genre} className="flex items-enter mr-4 mb-5">
                  <input
                    type="radio"
                    id={`radio-${genre}`}
                    name="genre"
